...
DATABASES = {
    'default': {
        ...
        'NAME': 'svatibor',   # Or path to database file if using sqlite3.
        'USER': 'svatibor',                      # Not used with sqlite3.
        'PASSWORD': 'svatibor',                  # Not used with sqlite3.
